...
own GitHub Apps, secrets, labels, and branch protection all need to be set up on your repo. See
[RUNBOOK.md → Self-hosting](plugins/aar-engineering/skills/ship-change/RUNBOOK.md#self-hosting) for what's
actually involved.
